...
export type ZusdFrontendConfig = {
  frontendTag: string;
  infuraApiKey?: string;
  testnetOnly?: boolean;
};

const defaultConfig: ZusdFrontendConfig = {
...
const parseConfig = (json: unknown): ZusdFrontendConfig => {
...
let configPromise: Promise<ZusdFrontendConfig> | undefined = undefined;
...
export const getConfig = (): Promise<ZusdFrontendConfig> => {
  if (!configPromise) {
