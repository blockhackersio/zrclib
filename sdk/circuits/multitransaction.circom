...
template MultiTransaction(levels, nIns, nOuts, zeroLeaf) {
    signal input root;
...
component main { public [root, publicAmount, publicAsset, extDataHash, inputNullifier, outputCommitment] } = MultiTransaction(5, 2, 2, 11850551329423159860688778991827824730037759162201783566284850822760196767874);