...
export interface ShieldedPoolWithBlocklistInterface extends utils.Interface {
  functions: {
...
export interface ShieldedPoolWithBlocklist extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShieldedPoolWithBlocklistInterface;
