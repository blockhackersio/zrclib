...
export interface CompliantVerifierInterface extends utils.Interface {
  functions: {
...
export interface CompliantVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompliantVerifierInterface;
