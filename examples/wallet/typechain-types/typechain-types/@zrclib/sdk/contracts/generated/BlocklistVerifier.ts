...
export interface BlocklistVerifierInterface extends utils.Interface {
  functions: {
...
export interface BlocklistVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BlocklistVerifierInterface;
