...
export interface CompliantTransactionVerifierInterface extends utils.Interface {
  functions: {
...
export interface CompliantTransactionVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompliantTransactionVerifierInterface;
